...
--
-- Servidor: mysql:3306
-- Tiempo de generación: 18-08-2022 a las 02:26:21
...
-- Procedimientos
--
CREATE DEFINER=`sail`@`%` PROCEDURE `ganador` ()   BEGIN
...
CREATE TABLE `ciudad` (
  `cod_ciudad` bigint UNSIGNED NOT NULL,
  `ciudad` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cod_departamento` bigint UNSIGNED NOT NULL
...
INSERT INTO `ciudad` (`cod_ciudad`, `ciudad`, `cod_departamento`) VALUES
(1, 'Abriaquí', 5),
(2, 'Acacías', 50),
(3, 'Acandí', 27),
(4, 'Acevedo', 41),
...
INSERT INTO `departamento` (`cod_departamento`, `departamento`) VALUES
(5, 'ANTIOQUIA'),
(8, 'ATLÁNTICO'),
(11, 'BOGOTÁ, D.C.'),
(13, 'BOLÍVAR'),
...
(5, '2022_08_16_135822_create_departamento_table', 1),
(6, '2022_08_16_135833_create_ciudad_table', 1),
(7, '2022_08_16_135834_create_participantes_table', 1);
...
CREATE TABLE `participantes` (
  `cod_participantes` bigint UNSIGNED NOT NULL,
  ...
  `token_validacion` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `participantes` (`cod_participantes`, `nombre`, `apellido`, `cedula`, `telefono`, `cod_departamento`, `cod_ciudad`, `correo`, `terminos_condiciones`, `validacion`, `token_validacion`, `ganador`, `created_at`, `updated_at`) VALUES
(1, 'Andres', 'Sanchez', 1124069317, 3008211790, 11, 107, 'talento790@gmail.com', 1, 1, '', NULL, '2022-08-18 01:37:51', '2022-08-18 01:38:09');
...
(1, 'Andres Sanchez', 'loscaminos@gmail.com', NULL, '$2y$10$TxwQkRyW.qnApRt14CwhFeGlplvQ6YS3x9nY2IbNnYmtbpoYslYWK', NULL, '2022-08-17 17:23:34', '2022-08-17 17:23:34');

-- --------------------------------------------------------

--
-- Estructura Stand-in para la vista `vista_participantes`
-- (Véase abajo para la vista actual)
--
CREATE TABLE `vista_participantes` (
`apellido` varchar(50)
,`cedula` bigint
,`ciudad` varchar(255)
,`cod_participantes` bigint unsigned
,`correo` varchar(80)
,`departamento` varchar(80)
,`fechaCreacion` timestamp
,`nombre` varchar(50)
,`telefono` bigint
,`validacion` tinyint(1)
);

-- --------------------------------------------------------

--
-- Estructura para la vista `vista_participantes`
--
DROP TABLE IF EXISTS `vista_participantes`;

CREATE ALGORITHM=UNDEFINED DEFINER=`sail`@`%` SQL SECURITY DEFINER VIEW `vista_participantes`  AS SELECT `p`.`cod_participantes` AS `cod_participantes`, `p`.`nombre` AS `nombre`, `p`.`apellido` AS `apellido`, `p`.`cedula` AS `cedula`, `p`.`telefono` AS `telefono`, `d`.`departamento` AS `departamento`, `c`.`ciudad` AS `ciudad`, `p`.`correo` AS `correo`, `p`.`created_at` AS `fechaCreacion`, `p`.`validacion` AS `validacion` FROM ((`participantes` `p` join `departamento` `d`) join `ciudad` `c`) WHERE ((`p`.`cod_departamento` = `d`.`cod_departamento`) AND (`p`.`cod_ciudad` = `c`.`cod_ciudad`))  ;
...
ALTER TABLE `ciudad`
  ...
  ADD KEY `ciudad_cod_departamento_foreign` (`cod_departamento`);
...
ALTER TABLE `participantes`
  ADD PRIMARY KEY (`cod_participantes`),
  ADD UNIQUE KEY `participantes_cedula_unique` (`cedula`),
  ADD UNIQUE KEY `participantes_telefono_unique` (`telefono`),
  ADD UNIQUE KEY `participantes_correo_unique` (`correo`),
  ADD KEY `participantes_cod_departamento_foreign` (`cod_departamento`),
  ADD KEY `participantes_cod_ciudad_foreign` (`cod_ciudad`);
...
--
ALTER TABLE `ciudad`
  MODIFY `cod_ciudad` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1101;

--
-- AUTO_INCREMENT de la tabla `departamento`
--
ALTER TABLE `departamento`
  MODIFY `cod_departamento` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `participantes`
  MODIFY `cod_participantes` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `ciudad`
  ADD CONSTRAINT `ciudad_cod_departamento_foreign` FOREIGN KEY (`cod_departamento`) REFERENCES `departamento` (`cod_departamento`);

--
-- Filtros para la tabla `participantes`
--
ALTER TABLE `participantes`
  ADD CONSTRAINT `participantes_cod_ciudad_foreign` FOREIGN KEY (`cod_ciudad`) REFERENCES `ciudad` (`cod_ciudad`),
  ADD CONSTRAINT `participantes_cod_departamento_foreign` FOREIGN KEY (`cod_departamento`) REFERENCES `departamento` (`cod_departamento`);

DELIMITER $$
--
-- Eventos
--
CREATE DEFINER=`sail`@`%` EVENT `e_ganador_ramdom` ON SCHEDULE EVERY 1 MINUTE STARTS '2022-08-18 01:07:12' ON COMPLETION NOT PRESERVE ENABLE DO call ganador()$$
